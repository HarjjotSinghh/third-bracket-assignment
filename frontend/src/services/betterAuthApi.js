...
var makeRequest = function (endpoint_1) {
    var args_1 = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        args_1[_i - 1] = arguments[_i];
    }
    return __awaiter(void 0, __spreadArray([endpoint_1], args_1, true), void 0, function (endpoint, options) {
        var url, defaultOptions, response, errorData;
        if (options === void 0) { options = {}; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(API_BASE_URL).concat(endpoint);
                    defaultOptions = __assign({ credentials: 'include', headers: __assign({ 'Content-Type': 'application/json' }, options.headers) }, options);
                    return [4 /*yield*/, fetch(url, defaultOptions)];
                case 1:
                    response = _a.sent();
...
export var taskAPI = {
    getAll: function (params) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            endpoint = queryString ? "/tasks?".concat(queryString) : '/tasks';
            return [2 /*return*/, makeRequest(endpoint)];
        });
    }); },
    getById: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, makeRequest("/tasks/".concat(id))];
        });
    }); },
    create: function (taskData) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, makeRequest('/tasks', {
                    method: 'POST',
                    body: JSON.stringify(taskData),
                })];
        });
    }); },
    update: function (id, taskData) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, makeRequest("/tasks/".concat(id), {
                    method: 'PUT',
                    body: JSON.stringify(taskData),
    ...
    getStats: function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, makeRequest('/tasks/stats')];
        });
    }); },
};
