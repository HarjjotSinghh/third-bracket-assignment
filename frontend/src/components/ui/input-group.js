...
function InputGroup(_a) {
    ...
    return (_jsx("div", __assign({ "data-slot": "input-group", role: "group", className: cn("group/input-group border-input dark:bg-input/30 relative flex w-full items-center rounded-md border shadow-xs transition-[color,box-shadow] outline-none", "h-9 min-w-0 has-[>textarea]:h-auto", 
...
function InputGroupAddon(_a) {
    ...
    return (_jsx("div", __assign({ role: "group", "data-slot": "input-group-addon", "data-align": align, className: cn(inputGroupAddonVariants({ align: align }), className), onClick: function (e) {
            var _a, _b;
...
function InputGroupButton(_a) {
    ...
    return (_jsx(Button, __assign({ type: type, "data-size": size, variant: variant, className: cn(inputGroupButtonVariants({ size: size }), className) }, props)));
}
function InputGroupText(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsx("span", __assign({ className: cn("text-muted-foreground flex items-center gap-2 text-sm [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4", className) }, props)));
}
function InputGroupInput(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsx(Input, __assign({ "data-slot": "input-group-control", className: cn("flex-1 rounded-none border-0 bg-transparent shadow-none focus-visible:ring-0 dark:bg-transparent", className) }, props)));
}
function InputGroupTextarea(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsx(Textarea, __assign({ "data-slot": "input-group-control", className: cn("flex-1 resize-none rounded-none border-0 bg-transparent py-3 shadow-none focus-visible:ring-0 dark:bg-transparent", className) }, props)));
}
